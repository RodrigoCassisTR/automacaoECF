...
import ECF.automacaoECF.acessoTela.TelaPlanoReferencialPlanoEmpresaConsulta;
import ECF.automacaoECF.consistencias.*;
import ECF.automacaoECF.integracao.*;
import ECF.automacaoECF.padrao.RecebeParametros;
import ECF.automacaoECF.tela.*;
...
public class TesteSuite {
	...
	public static void main(String[] args) throws IOException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException {
		...
		Class<?>[] testesIntegracao = {IntegracaoAccountBalanceTXT.class,IntegracaoAccountEntryTXT.class,IntegracaoBranchTXT.class,IntegracaoChartsOfAccountsAssociationTXT.class,IntegracaoCostCenterTXT.class,IntegracaoLedgerAccountTXT.class,IntegracaoLongTermintereStrateTXT.class,IntegracaoSocietyAccountParticipationTXT.class,IntegracaoAccountBalanceXML.class,IntegracaoAccountEntryXML.class,IntegracaoBranchXML.class,IntegracaoChartsOfAccountsAssociationXML.class,IntegracaoCostCenterXML.class,IntegracaoLedgerAccountXML.class,IntegracaoLongTermintereStrateXML.class,IntegracaoSocietyAccountParticipationXML.class};
		//,ConsistenciasAccountBalance.class,ConsistenciasAccountEntry.class,ConsistenciasBranch.class,ConsistenciasChartsOfAccountsAssociation.class,ConsistenciasCostCenter.class,ConsistenciasLedgerAccount.class,ConsistenciasLongTermInterestRate.class,ConsistenciasSocietyAccountParticipation.class
