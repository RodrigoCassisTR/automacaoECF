...
public class TesteSuite {
	...
	public static void main(String[] args) throws IOException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException {
		...
		Class<?>[] testesIntegracao = {IntegracaoAccountBalanceXML.class, IntegracaoAccountEntryXML.class, IntegracaoBranchXML.class, IntegracaoChartsOfAccountsAssociationXML.class, IntegracaoCostCenterXML.class, IntegracaoLedgerAccountXML.class, IntegracaoLongTermintereStrateXML.class, IntegracaoSocietyAccountParticipationXML.class, ConsistenciasBranch.class, ConsistenciasCostCenter.class, ConsistenciasLedgerAccount.class, ConsistenciasLongTermInterestRate.class, ConsistenciasAccountBalance.class,ConsistenciasSocietyAccountParticipation.class,ConsistenciasAccountEntry.class,ConsistenciasChartsOfAccountsAssociation.class};
