...
public class TelaTaxaSelicAcesso extends CasoDeTesteBasico {

	org.apache.log4j.Logger logger = Logger.getLogger(TelaTaxaSelicAcesso.class.getName());
	...
	@Test
	public void testTelaTaxaSelic() throws Throwable {
