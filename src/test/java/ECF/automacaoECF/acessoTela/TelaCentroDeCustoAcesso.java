...
public class TelaCentroDeCustoAcesso extends CasoDeTesteBasico {

	org.apache.log4j.Logger logger = Logger.getLogger(TelaCentroDeCustoAcesso.class.getName());
	...
	@Test
	public void testTelaCentroDeCusto() throws Throwable {
