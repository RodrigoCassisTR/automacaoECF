...
public class TelaSaldosAcesso extends CasoDeTesteBasico {

	org.apache.log4j.Logger logger = Logger.getLogger(TelaSaldosAcesso.class.getName());
	...
	@Test
	public void testelaSaldosAcesso() throws Throwable {
