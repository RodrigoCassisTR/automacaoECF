...
public class TelaPlanoDeContasAcesso extends CasoDeTesteBasico {

	org.apache.log4j.Logger logger = Logger.getLogger(TelaPlanoDeContasAcesso.class.getName());
	...
	@Test
	public void testTelaPlanoDeContas() throws Throwable {
