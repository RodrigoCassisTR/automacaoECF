...
public class TelaTipoDeFeriadoAcesso extends CasoDeTesteBasico {

	org.apache.log4j.Logger logger = Logger.getLogger(TelaTipoDeFeriadoAcesso.class.getName());
	...
	@Test
	public void testelaTipoDeFeriadoAcesso() throws Throwable {
